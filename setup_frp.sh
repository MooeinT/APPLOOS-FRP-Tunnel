...
# ==================================================================================
#
#   APPLOOS FRP TUNNEL - Full Management Script (v41.0 - Comprehensive & Final)
...
get_protocol_choice() {
    ...
    # SUDP removed as it was problematic
...
main_menu() {
    while true; do
        ...
        echo "================================================="; echo -e "      ${CYAN}APPLOOS FRP TUNNEL${NC} - v41.0"; echo "================================================="
